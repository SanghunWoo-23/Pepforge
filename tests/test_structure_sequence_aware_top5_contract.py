...
def test_top_five_uses_quality_ranking_without_forced_family_diversity():
    rows = [
        {"conf_id": 1, "family": "alpha_helix_like", "energy": 4.0, "severe_steric_clashes": 0},
        {"conf_id": 2, "family": "alpha_helix_like", "energy": 2.0, "severe_steric_clashes": 0},
        {"conf_id": 3, "family": "turn_rich", "energy": 3.0, "severe_steric_clashes": 0},
        {"conf_id": 4, "family": "coil_mixed", "energy": 1.0, "severe_steric_clashes": 0},
        {"conf_id": 5, "family": "PPII_like", "energy": 5.0, "severe_steric_clashes": 0},
        {"conf_id": 6, "family": "beta_extended_like", "energy": 6.0, "severe_steric_clashes": 0},
        {"conf_id": 7, "family": "coil_mixed", "energy": 0.5, "severe_steric_clashes": 0},
    ]
    evidence = sequence_conformation_evidence(_tokens("EEMQRR"))
    selected = select_top_conformers({"conformers": rows}, evidence, limit=5)
    assert len(selected) == 5
    assert [row["rank"] for row in selected] == [1, 2, 3, 4, 5]
    # Multiple conformers from the same family are allowed; diversity is not a selection objective.
