...
def test_v5_material_parser_preserves_unitless_values_for_review(tmp_path):
    ...
    from spps_v4_gui.v5_material_usage import extract_cleavage_usage_workbook
...
def test_v5_difficulty_map_is_review_only():
    from spps_v4_gui.decision_support_v5 import sequence_difficulty_map
...
def test_v5_model_rebuild_is_explicit_and_requires_verified_data(tmp_path, monkeypatch):
    from spps_v4_gui import experimental_data, model_registry_v5
...
def test_v5_stage_risk_advisor_separates_loading_coupling_cleavage(tmp_path):
    from spps_v4_gui import experimental_data
    from spps_v4_gui.decision_support_v5 import stage_risk_advisor
    db=tmp_path/'exp.sqlite'
