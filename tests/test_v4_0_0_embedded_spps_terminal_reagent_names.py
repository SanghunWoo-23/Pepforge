...
from spps_v4_gui.calculation_context import canonical, material_lookup
...
def test_generic_legacy_nterm_purpose_suffix_is_removed():
    assert canonical("Example reagent for N-terminal modification") == "Example reagent"
    assert canonical("Example reagent for N terminal modification") == "Example reagent"


def test_operator_material_canonicalization_cleans_legacy_terminal_names():
    from spps_v4_gui.catalogs import canonical_unit_name
    assert canonical_unit_name("Acetic anhydride (Ac2O) for N-terminal acetylation") == "Acetic anhydride (Ac2O)"
    assert canonical_unit_name("Palmitic acid / palmitoyl coupling") == "Palmitic acid"
    assert canonical_unit_name("Example reagent for N-terminal modification") == "Example reagent"
