...
SPPS Planner V5.0.0 application engine and required data, embedded in Pepforge V4.0.0.
...
- The embedded SPPS module reports V4.0.0; the surrounding Pepforge release remains V4.0.0.
