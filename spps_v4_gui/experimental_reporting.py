...
def v6_analytics(db_path: str | Path | None = None) -> dict[str, Any]:
    from spps_v4_gui import experimental_data as data
    from spps_v4_gui.decision_support import analytics_snapshot
...
def quality_findings(db_path: str | Path | None = None) -> list[dict[str, Any]]:
    from spps_v4_gui import experimental_data as data
    from spps_v4_gui.decision_support import record_quality_issues
